...
def get_controls(display_parameters, frame_steps=25, frame_width=201):
    ...
    grid_color = ColorPicker(concise=True, value='white', disabled=False, description='Grid color')
    ...
    controls = {
        'rule': rule,
        'base': base,
        'use_highlight': highlight_checkbox,
...
def display_automaton(rule=90, base=2,
                      use_highlight=True, h_start=0, h_width=21, h_offset=0, h_steps=20,
                      grid_color='white',
...
def interactive_display_automaton(frame_steps=80, frame_width=151, fig_width=12):
